sap.ui.define([
		...
		"prodrive/EWM_DECON_MONITOR/test/integration/pages/shareOptions"
			...
			onTheWorklistPage : {
						...
						return this.waitFor(createWaitForItemAtPosition({
							...
							success : function (oTableItem) {
								...
								this.getContext().currentItem = {
									...
									id: oBindingContext.getProperty("DocumentGuid"),
									name: oBindingContext.getProperty("ConsolidationGroup")
								};
							}
						}));
					},
				...
				assertions: jQuery.extend({
					...
					theTableShouldHaveAllEntries : function () {
						...
						// retrieve all StorageBinSet to be able to check for the total amount
