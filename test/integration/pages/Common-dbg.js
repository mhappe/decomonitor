sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("prodrive/EWM_DECON_MONITOR/app", ".html");
		...
		return Opa5.extend("prodrive.EWM_DECON_MONITOR.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["prodrive/EWM_DECON_MONITOR/localService/mockserver"], function (mockserver) {
